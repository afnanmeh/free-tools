    ...
    <ToolLayout>
      <ToolHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Color Blind Simulator', href: '/design-tools/color-blind-simulator' },
        ]}
      />
        ...
        {simulations && (
          <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="lg">
            <Paper style={{ backgroundColor: '#111', border: '3px solid #44ff44', padding: '2rem' }}>
              ...
              <Paper style={{ backgroundColor: simulations.original, border: '2px solid #222', padding: '4rem', marginBottom: '1rem', minHeight: '150px' }} />
            ...
            <Paper style={{ backgroundColor: '#111', border: '3px solid #ff4444', padding: '2rem' }}>
              ...
              <Paper style={{ backgroundColor: simulations.protanopia, border: '2px solid #222', padding: '4rem', marginBottom: '1rem', minHeight: '150px' }} />
            ...
            <Paper style={{ backgroundColor: '#111', border: '3px solid #44ff44', padding: '2rem' }}>
              ...
              <Paper style={{ backgroundColor: simulations.deuteranopia, border: '2px solid #222', padding: '4rem', marginBottom: '1rem', minHeight: '150px' }} />
            ...
            <Paper style={{ backgroundColor: '#111', border: '3px solid #00d4ff', padding: '2rem' }}>
              ...
              <Paper style={{ backgroundColor: simulations.tritanopia, border: '2px solid #222', padding: '4rem', marginBottom: '1rem', minHeight: '150px' }} />
