    ...
    <ToolLayout>
      <ToolHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Random Color', href: '/design-tools/random-color-generator' },
        ]}
      />
      ...
      <Stack gap="xl">
        ...
        {colors.length > 0 && (
          <SimpleGrid cols={{ base: 2, sm: 3, md: 5 }} spacing="md">
            {colors.map((color, i) => (
              <Paper key={i} style={{ backgroundColor: color, border: '2px solid #222', padding: '4rem 1rem', textAlign: 'center', position: 'relative', minHeight: '200px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
