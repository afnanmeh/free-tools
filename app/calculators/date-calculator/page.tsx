    ...
    <ToolLayout>
      ...
      <Stack gap="xl">
        <Stack gap="md">
          ...
          <DatePickerInput value={date1} onChange={(value) => setDate1(value as Date | null)} size="lg" styles={{ input: { backgroundColor: '#111', border: '2px solid #7c00f0', color: '#fff' } }} />
        </Stack>

        <Stack gap="md">
          <div style={{ color: '#fff', fontWeight: 700, fontSize: '1.1rem' }}>END DATE</div>
          <DatePickerInput value={date2} onChange={(value) => setDate2(value as Date | null)} size="lg" styles={{ input: { backgroundColor: '#111', border: '2px solid #7c00f0', color: '#fff' } }} />
        </Stack>
