    ...
    <ToolLayout>
      <ToolHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Currency', href: '/calculators/currency-converter' },
        ]}
      />
      ...
      <Stack gap="xl">
        ...
        <Stack gap="md">
          ...
          <Select value={fromCurrency} onChange={(val) => setFromCurrency(val || 'USD')} data={currencies} size="lg" styles={{
              input: { backgroundColor: '#111', border: '2px solid #00d4ff', color: '#fff' },
              option: { backgroundColor: '#111', color: '#fff', '&[data-selected]': { backgroundColor: '#00d4ff' }, '&[data-hovered]': { backgroundColor: '#333' } },
              dropdown: { backgroundColor: '#111', border: '2px solid #00d4ff' }
            }} />
        </Stack>

        <Stack gap="md">
          <div style={{ color: '#fff', fontWeight: 700, fontSize: '1.1rem' }}>TO CURRENCY</div>
          <Select value={toCurrency} onChange={(val) => setToCurrency(val || 'EUR')} data={currencies} size="lg" styles={{
              input: { backgroundColor: '#111', border: '2px solid #00d4ff', color: '#fff' },
              option: { backgroundColor: '#111', color: '#fff', '&[data-selected]': { backgroundColor: '#00d4ff' }, '&[data-hovered]': { backgroundColor: '#333' } },
              dropdown: { backgroundColor: '#111', border: '2px solid #00d4ff' }
            }} />
