    ...
    <ToolLayout>
      <ToolHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Bandwidth', href: '/calculators/bandwidth-calculator' },
        ]}
      />
      ...
      <Stack gap="xl">
        ...
        <Stack gap="md">
          ...
          <Select value={period} onChange={(val) => setPeriod(val as any)} data={[{ value: 'day', label: 'Per Day' }, { value: 'month', label: 'Per Month' }]} size="lg" styles={{
