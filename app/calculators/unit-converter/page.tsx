    ...
    <ToolLayout>
      ...
      <Stack gap="xl">
        ...
        <Stack gap="md">
          ...
          <Select value={fromUnit} onChange={(val) => setFromUnit(val || 'cm')} data={units} size="lg" styles={{
        ...
        <Stack gap="md">
          ...
          <Select value={toUnit} onChange={(val) => setToUnit(val || 'in')} data={units} size="lg" styles={{
              input: { backgroundColor: '#111', border: '2px solid #00d4ff', color: '#fff' },
              option: { backgroundColor: '#111', color: '#fff', '&[data-selected]': { backgroundColor: '#00d4ff' }, '&[data-hovered]': { backgroundColor: '#333' } },
              dropdown: { backgroundColor: '#111', border: '2px solid #00d4ff' }
            }} />
