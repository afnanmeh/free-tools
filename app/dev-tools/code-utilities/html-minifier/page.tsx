...
import { minifyHtml } from '@/lib/tools/code/minifiers';
...
export default function HtmlMinifierPage() {
  ...
  return (
    <ToolLayout>
      <ToolHeader
        title="HTML MINIFIER"
        description="Minify HTML by removing whitespace, comments, and unnecessary characters. Reduce file size for faster page loads."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Dev Tools', href: '/dev-tools' },
          { label: 'Code Utilities', href: '/dev-tools/code-utilities' },
          { label: 'HTML Minifier', href: '/dev-tools/code-utilities/html-minifier' },
        ]}
      />
